...
//		Account existingSrcAccount = em.merge(srcAccount);
//		Account existingDestAccount = em.merge(destAccount);
//		
//		existingSrcAccount.debit(amount);
//		existingDestAccount.credit(amount);
//	}
//
